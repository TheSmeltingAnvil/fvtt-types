...
export const canvasTextStyle: PIXI.TextStyle
...
export const fontDefinitions: Record<string, CONFIG.FontFamilyDefinition>

export const i18n: { searchMinimumCharacterLength: number }
 ...
 */
export const statusEffects: CONFIG.StatusEffectConfig[]
...
export const time: {
   ...
   */
  worldCalendarClass: typeof data.CalendarData
  /**
...
export const ui: {
  ...
  chat: ConstructorOf<sidebar.tabs.ChatLog>
  combat: ConstructorOf<sidebar.tabs.CombatTracker>
  compendium: ConstructorOf<sidebar.tabs.CompendiumDirectory>
  controls: typeof applications.ui.SceneControls
  hotbar: ConstructorOf<applications.ui.Hotbar>
...
export const ActorDelta: {
  documentClass: ConstructorOf<documents.ActorDelta<null>>
}

export const AmbientLight: {
  documentClass: ConstructorOf<documents.AmbientLightDocument<Scene>>
  // @ts-expect-error Should fix.
...
export const AmbientSound: {
  documentClass: ConstructorOf<documents.AmbientSoundDocument<Scene>>
  // @ts-expect-error Should fix.
...
export const Canvas: {
  ...
  groups: {
    effects: { groupClass: canvas.groups.EffectsCanvasGroup; parent: string }
    // @ts-expect-error Should fix.
...
export const ChatMessage: {
  ...
  dataModels: Record<string, typeof abstract.TypeDataModel>
  documentClass: ConstructorOf<documents.ChatMessage>
...
export const Combatant: {
  ...
  documentClass: ConstructorOf<Combatant>
  typeIcons: Record<string, string>
  typeLabels: Record<string, string>
}
...
export const DatabaseBackend: data.ClientDatabaseBackend
...
export const MeasuredTemplate: {
  ...
  documentClass: ConstructorOf<MeasuredTemplateDocument>
  // @ts-expect-error Should fix.
 ...
 */
export const Region: {
  documentClass: ConstructorOf<RegionDocument>
  // @ts-expect-error Should fix.
...
export const RegionBehavior: {
  ...
  documentClass: ConstructorOf<RegionBehavior>
  typeIcons: Record<string, string>
  typeLabels: Record<string, string>
}
 ...
 */
export const Tile: {
  documentClass: ConstructorOf<documents.TileDocument<Scene | null>>
...
export const Token: {
  ...
  documentClass: ConstructorOf<TokenDocument>
...
export const Wall: {
  ...
  documentClass: ConstructorOf<documents.WallDocument>
...
export { default as CursorDescriptor } from "./CursorDescriptor.js"
export type * from "./DarknessSourceAnimation.js"
export * from "./DiceFulfillment.js"
export * from "./FontFamily.js"
export * from "./FontFamily.js"
export type * from "./LightSourceAnimation.js"
export * from "./RollFunction.js"
export * from "./StatusEffect.js"
export * from "./TextEditorEnricher.js"
export * from "./types.js"
export * from "./WallDoorAnimation.js"
export { default as WallDoorAnimationConfig } from "./WallDoorAnimation.js"
export { default as WallDoorSound } from "./WallDoorSound.js"
