 ...
 */
export function deepFreeze<const T extends object>(
  obj: T,
  {
    strict,
  }?: {
 ...
 */
export function deepSeal<T extends object>(
  obj: T,
  {
    strict,
  }?: {
...
export function mergeObject(
  ...
  other?: object,
  {
    ...
    performDeletions?: boolean | undefined
  },
  _d?: number,
): object
/**
...
export function parseUuid(
  uuid: string,
  {
    ...
    relative?: foundry.abstract.Document<object, foundry.abstract.types.DocumentConstructionContext> | undefined
  },
): ResolvedUUID | null
/**
...
export function buildUuid({
  ...
  parent?: Document | null | undefined
