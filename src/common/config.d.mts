 ...
 */
export class ReleaseData extends DataModel<object, abstract.types.DataModelConstructionContext> {
  /** @override */
 ...
 */
export class ServerSettings extends DataModel<object, foundry.abstract.types.DataModelConstructionContext> {
  static defineSchema(): {
