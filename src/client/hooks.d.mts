 ...
 * @category Game
 */
export function streamReady(): void
/**
 ...
 */
export function error(location: string, error: Error, data: object): void
/**
 ...
 */
export function updateWorldTime(worldTime: number, dt: number, options: object, userId: string): void
/**
 ...
 */
export function canvasConfig(config: object): void
/**
 ...
 */
export function canvasInit(canvas: Canvas): void
/**
 ...
 */
export function canvasPan(canvas: Canvas, position: CanvasViewPosition): void
/**
 ...
 */
export function canvasReady(canvas: Canvas): void
/**
 ...
 */
export function canvasTearDown(canvas: Canvas): void
/**
 ...
 */
export function canvasDraw(canvas: Canvas): void
/**
 ...
 */
export function dropCanvasData(canvas: Canvas, data: Point & object, event: DragEvent): void
/**
 ...
 */
export function highlightObjects(active: boolean): void
/**
 * A hook event that fires when canvas edges are being initialized.
 * @event
 * @category Canvas
 */
export function initializeEdges(): void
/**
 ...
 */
export function renderApplicationV2(
 ...
 */
export function renderApplicationV1(application: Application, html: JQuery, data: object): void
/**
 ...
 */
export function getHeaderControlsApplicationV2(
  application: ApplicationV2,
 ...
 */
export function getApplicationV1HeaderButtons(application: Application, buttons: ApplicationV1HeaderButton[]): void
/**
 ...
 */
export function closeApplicationV2(application: ApplicationV2): void
/**
 ...
 */
export function closeApplicationV1(application: Application, html: JQuery): void
/**
 ...
 * });
 */
export function getSceneControlButtons(controls: Record<string, SceneControl>): void
/**
 ...
 */
export function hotbarDrop(hotbar: Hotbar, data: object, slot: number): void
/**
 ...
 */
export function getDocumentContextOptions(application: ApplicationV2, menuItems: ContextMenuEntry[]): void
/**
 ...
 */
export function collapseSidebar(sidebar: Sidebar, collapsed: boolean): void
/**
 ...
 */
export function changeSidebarTab(app: AbstractSidebarTab): void
/**
 ...
 */
export function collapseSceneNavigation(app: SceneNavigation, collapsed: boolean): void
/**
 ...
 */
export function drawGroup(group: CanvasGroup): void
/**
 ...
 */
export function tearDownGroup(group: CanvasGroup): void
/**
 ...
 */
export function drawLayer(layer: CanvasLayer): void
/**
 ...
 */
export function tearDownLayer(layer: CanvasLayer): void
/**
 ...
 */
export function pastePlaceableObject(
 ...
 */
export function preCreateDocument(
  document: Document,
  data: object,
 ...
 */
export function preUpdateDocument(
  document: Document,
  changed: object,
 ...
 */
export function preDeleteDocument(
  document: Document,
 ...
 */
export function createDocument(document: Document, options: Partial<DatabaseCreateOperation>, userId: string): void
/**
 ...
 */
export function deleteDocument(document: Document, options: Partial<DatabaseDeleteOperation>, userId: string): void
/**
 ...
 */
export function stopToken(document: TokenDocument): void
/**
 ...
 */
export function pauseToken(document: TokenDocument): void
/**
 ...
 */
export function recordToken(document: TokenDocument): void
/**
 ...
 */
export function drawObject(object: PlaceableObject): void
/**
 ...
 */
export function refreshObject(object: PlaceableObject): void
/**
 ...
 */
export function destroyObject(object: PlaceableObject): void
/**
 ...
 */
export function controlObject(object: PlaceableObject, controlled: boolean): void
/**
 ...
 */
export function hoverObject(object: PlaceableObject, hovered: boolean): void
/**
 ...
 */
export function applyTokenStatusEffect(token: Token, statusId: string, active: boolean): void
/**
 ...
 */
export function chatBubbleHTML(
  token: Token,
  html: HTMLElement,
  message: string,
 ...
 */
export function modifyTokenAttribute(
  {
    attribute,
    value,
    isDelta,
 ...
 */
export function targetToken(user: User, token: Token, targeted: boolean): void
/**
 ...
 */
export function activateNote(note: Note, options: object): void
/**
 ...
 */
export function initializeRenderedEffectSourceShaders(source: RenderedEffectSource): void
/**
 ...
 */
export function applyCompendiumArt(
 ...
 */
export function dropActorSheetData(actor: Actor, sheet: ActorSheet, data: object): void
/**
 ...
 */
export function activateLayer(layer: InteractionLayer): void
/**
 * A hook event that fires when a {@link foundry.canvas.layers.InteractionLayer} becomes active.
 * @event
 * @category InteractionLayer
 * @param {InteractionLayer} layer  The layer becoming active.
 */
export function activateCanvasLayer(layer: InteractionLayer): void
/**
 ...
 */
export function deactivateLayer(layer: InteractionLayer): void
/**
 ...
 */
export function configureCanvasEnvironment(config: CanvasEnvironmentConfig): void
/**
 ...
 * @category EnvironmentCanvasGroup
 */
export function initializeCanvasEnvironment(): void
/**
 ...
 */
export function initializeVisionMode(visibility: CanvasVisibility): void
/**
 ...
 */
export function initializeVisionSources(sources: Collection<string, PointVisionSource>): void
/**
 ...
 */
export function lightingRefresh(group: EffectsCanvasGroup): void
/**
 ...
 * @param {CanvasVisibility} visibility The CanvasVisibility instance
 */
export function visibilityRefresh(visibility: CanvasVisibility): void
/**
 ...
 */
export function initializeLightSources(group: EffectsCanvasGroup): void
/**
 ...
 */
export function initializePriorityLightSources(group: EffectsCanvasGroup): void
/**
 ...
 */
export function sightRefresh(visibility: CanvasVisibility): void
/**
 ...
 */
export function initializeWeatherEffects(weatherEffect: WeatherEffects, weatherEffectsConfig: object): void
/**
 ...
 */
export function preImportAdventure(
  adventure: Adventure,
  formData: object,
 ...
 */
export function importAdventure(
  adventure: Adventure,
  formData: object,
 ...
 */
export function userConnected(user: User, connected: boolean): void
/**
 ...
 */
export function combatTurnChange(combat: Combat, prior: CombatHistoryData, current: CombatHistoryData): void
/**
 ...
 */
export function initializeCombatConfiguration(config: CombatConfiguration): void
/**
 ...
 */
export function getProseMirrorMenuDropDowns(
 ...
 */
export function getProseMirrorMenuItems(menu: ProseMirrorMenu, config: ProseMirrorMenuItem[]): void
/**
 ...
 */
export function hotReload(data: HotReloadData): void
/**
 ...
 */
export function renderChatMessageHTML(message: ChatMessage, html: HTMLElement, context: object): void
/**
 ...
 */
export function globalVolumeChanged(volume: number): void
/**
 ...
 */
export function rtcSettingsChanged(settings: AVSettings, changed: object): void
/**
 ...
 */
export function clientSettingChanged(key: string, value: any, options: object): void
/**
 ...
 */
export function dropRollTableSheetData(table: RollTable, sheet: RollTableSheet, data: object): void
/**
 ...
 */
export function initializeDynamicTokenRingConfig(ringConfig: TokenRingConfig): void
export type RenderChatInputContext = {
  /**
...
import type { ProseMirrorDropDownConfig, ProseMirrorMenuItem } from "@common/prosemirror/_types.mjs"
import type ProseMirrorMenu from "@common/prosemirror/menu.mjs"
import type { CanvasViewPosition, HotReloadData } from "./_types.mjs"
import type {
...
import type ActorSheet from "./applications/sheets/actor-sheet.mjs"
import type RollTableSheet from "./applications/sheets/roll-table-sheet.mjs"
import type AbstractSidebarTab from "./applications/sidebar/sidebar-tab.mjs"
import type Sidebar from "./applications/sidebar/sidebar.mjs"
import type ChatLog from "./applications/sidebar/tabs/chat.mjs"
import type Hotbar from "./applications/ui/hotbar.mjs"
import type { SceneControl } from "./applications/ui/scene-controls.mjs"
import type SceneNavigation from "./applications/ui/scene-navigation.mjs"
import type { ContextMenuEntry } from "./applications/ux/context-menu.mjs"
import type Application from "./appv1/api/application-v1.mjs"
import type { ApplicationV1HeaderButton } from "./appv1/api/application-v1.mjs"
import type AVSettings from "./av/settings.mjs"
import type { ChatBubbleOptions } from "./canvas/animation/chat-bubbles.mjs"
import type Canvas from "./canvas/board.mjs"
import type EffectsCanvasGroup from "./canvas/groups/effects.mjs"
import type { CanvasEnvironmentConfig } from "./canvas/groups/environment.mjs"
import type CanvasVisibility from "./canvas/groups/visibility.mjs"
import type { CanvasLayer, InteractionLayer, WeatherEffects } from "./canvas/layers/_module.mjs"
import type { Note, PlaceableObject, Token } from "./canvas/placeables/_module.mjs"
import type TokenRingConfig from "./canvas/placeables/tokens/ring-config.mjs"
import type PointVisionSource from "./canvas/sources/point-vision-source.mjs"
import type RenderedEffectSource from "./canvas/sources/rendered-effect-source.mjs"
import type CombatConfiguration from "./data/combat-config.mjs"
import type {
  Actor,
  Adventure,
  Card,
...
import type { CombatHistoryData, EffectChangeData, TokenMovementOperation } from "./documents/_types.mjs"
import type CompendiumCollection from "./documents/collections/compendium-collection.mjs"
import type { CompendiumArtInfo } from "./helpers/_types.mjs"
