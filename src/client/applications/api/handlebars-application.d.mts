import * as applications from "@client/applications/_types.mjs"
import { AbstractConstructorOf, DeepPartial } from "@common/_types.mjs"
import { types } from "../_module.mjs"
import * as api from "./_module.mjs"

export declare type HandlebarsApplication = InstanceType<ReturnType<typeof HandlebarsApplicationMixin>>

declare abstract class HandlebarsApplicationMixinType<_TBase extends api.ApplicationV2> extends api.ApplicationV2 {
  /** @inheritdoc */
...
declare function HandlebarsApplicationMixin<TBase extends api.ApplicationV2>(
  Base: AbstractConstructorOf<TBase>,
): AbstractConstructorOf<HandlebarsApplicationMixinType<TBase> & TBase>
