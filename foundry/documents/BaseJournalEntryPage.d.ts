...
import BaseJournalEntry from "./BaseJournalEntry.js"
import { BaseUser } from "./_module.js"

/** The JournalEntryPage document model. */
export default class BaseJournalEntryPage<TParent extends BaseJournalEntry | null> extends foundry.abstract.Document<
  TParent,
...
export default interface BaseJournalEntryPage<TParent extends BaseJournalEntry | null>
  extends foundry.abstract.Document<TParent, JournalEntryPageSchema>,
...
> = {
  ...
  text: fields.SchemaField<{
    ...
    format: fields.NumberField<CONST.JournalEntryPageFormat>
  }>
