import { EnrichmentAnchorOptions } from "config/types.js"
...
export default function ClientDocumentMixin<
  ...
  TDocument extends foundry.abstract.Document<TParent>,
>(Base: ConstructorOf<TDocument>): ConstructorOf<ClientDocument<TParent> & TDocument>

export class ClientDocument<
  TParent extends foundry.abstract.Document | null = foundry.abstract.Document | null,
> extends foundry.abstract.Document<TParent> {
   ...
   */
  protected _preCreateDescendantDocuments<P extends foundry.abstract.Document>(
    parent: P,
    collection: string,
    data: object[],
   ...
   * @param userId     The ID of the User who triggered the operation
   */
  protected _onCreateDescendantDocuments<P extends foundry.abstract.Document>(
    parent: P,
    collection: string,
    documents: foundry.abstract.Document<P>[],
    data: object[],
    options: DatabaseCreateOperation<P>,
    userId: string,
  ): void
   ...
   * @param userId     The ID of the User who triggered the operation
   */
  protected _preUpdateDescendantDocuments<P extends foundry.abstract.Document>(
    parent: P,
    collection: string,
    changes: Record<string, unknown>[],
   ...
   * @param userId The ID of the User who triggered the operation
   */
  protected _onUpdateDescendantDocuments<P extends foundry.abstract.Document>(
    parent: P,
    collection: string,
    documents: foundry.abstract.Document<P>[],
    changes: Record<string, unknown>[],
   ...
   * @protected
   */
  protected _preDeleteDescendantDocuments<P extends foundry.abstract.Document>(
    parent: P,
    collection: string,
    ids: string[],
   ...
   * @param userId     The ID of the User who triggered the operation
   */
  protected _onDeleteDescendantDocuments<P extends foundry.abstract.Document>(
    parent: P,
    collection: string,
    documents: foundry.abstract.Document<P>[],
    ids: string[],
   ...
   */
  static createDialog<T extends typeof foundry.abstract.Document>(
    this: T,
    data?: object,
    createOptions?: DatabaseCreateOperation<foundry.abstract.Document | null>,
    options?: {
   ...
   */
  static fromDropData<T extends typeof foundry.abstract.Document>(
    this: T,
    data: object,
    options?: object,
  ): Promise<InstanceType<T>>
   ...
   */
  fromImport<T extends typeof foundry.abstract.Document>(
    this: T,
    source: object,
    context?: DocumentConstructionContext<foundry.abstract.Document | null> & {
      strict?: boolean
    },
  ): Promise<InstanceType<T>>
...
export interface ClientDocumentStatic {
   ...
   * @returns A Promise which resolves to the created Document, or null if the dialog was closed.
   */
  createDialog<T extends foundry.abstract.Document>(
    this: ConstructorOf<T>,
    data?: object,
    createOptions?: Partial<DatabaseCreateOperation<foundry.abstract.Document | null>>,
    options?: {
      folders?: { id: string; name: string }[]
      types?: string[]
      template?: string
...
export interface DatabaseDeleteCallbackOptions
  extends Omit<Partial<DatabaseDeleteOperation<null>>, "action" | "deleteAll" | "ids" | "pack" | "parent" | "noHook"> {}
