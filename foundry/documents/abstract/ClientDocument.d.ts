...
//import * as appv1 from "../../appv1/_module.js"
//import * as applications from "../../applications/_module.js"
//import * as CONST from "../../../const/_module.js"
...
//import { DocumentHTMLEmbedConfig, EnrichmentAnchorOptions } from "config/types.js"
//import HTMLDocumentEmbedElement from "foundry/applications/elements/HTMLDocumentEmbedElement.js"
//import { SortOptions } from "foundry/utils/helpers.js"

//export default class ClientDocument<
//  TParent extends abstract.Document | null = abstract.Document | null,
//> extends abstract.Document<TParent> {
//  readonly apps: Record<string, appv1.api.Application | applications.api.ApplicationV2>
...
//   * ```
//   */
//  get permission(): CONST.DocumentOwnershipLevel

//  /**
//   * Lazily obtain a Application instance used to configure this Document, or null if no sheet is available.
//   */
//  get sheet(): appv1.api.Application | applications.api.ApplicationV2 | null
...
//   * @internal
//   */
//  _getSheetClass(): typeof appv1.api.Application | typeof applications.api.ApplicationV2 | null
...
//   */
//  protected _preCreateDescendantDocuments<P extends abstract.Document>(
//    parent: P,
//    collection: string,
//    data: object[],
...
//   * @param userId     The ID of the User who triggered the operation
//   */
//  protected _onCreateDescendantDocuments<P extends abstract.Document>(
//    parent: P,
//    collection: string,
//    documents: abstract.Document<P>[],
//    data: object[],
//    options: DatabaseCreateOperation<P>,
//    userId: string,
//  ): void
...
//   * @param userId     The ID of the User who triggered the operation
//   */
//  protected _preUpdateDescendantDocuments<P extends abstract.Document>(
//    parent: P,
//    collection: string,
//    changes: Record<string, unknown>[],
...
//   * @param userId The ID of the User who triggered the operation
//   */
//  protected _onUpdateDescendantDocuments<P extends abstract.Document>(
//    parent: P,
//    collection: string,
//    documents: abstract.Document<P>[],
//    changes: Record<string, unknown>[],
...
//   * @protected
//   */
//  protected _preDeleteDescendantDocuments<P extends abstract.Document>(
//    parent: P,
//    collection: string,
//    ids: string[],
...
//   * @param userId     The ID of the User who triggered the operation
//   */
//  protected _onDeleteDescendantDocuments<P extends abstract.Document>(
//    parent: P,
//    collection: string,
//    documents: abstract.Document<P>[],
//    ids: string[],
...
//   */
//  static createDialog<T extends typeof abstract.Document>(
//    this: T,
//    data?: object,
//    createOptions?: DatabaseCreateOperation<abstract.Document | null>,
//    options?: {
...
//    this: T,
//    source: object,
//    context?: DocumentConstructionContext<abstract.Document | null> & { strict?: boolean },
//  ): Promise<InstanceType<T>>
...
//    options?: CONFIG.EnrichmentOptions,
...
//    content: HTMLElement | HTMLCollection,
//    config: CONFIG.DocumentHTMLEmbedConfig,
//    options: CONFIG.EnrichmentOptions,
//  ): Promise<HTMLElement | null>
//}
...
//   * @param context.pack A compendium pack within which the Document should be created
//   */
//  defaultName(context?: { type?: string | null; parent?: abstract.Document | null; pack?: string | null }): string
...
//   * @returns A Promise which resolves to the created Document, or null if the dialog was closed.
//   */
//  createDialog<T extends abstract.Document>(
//    this: ConstructorOf<T>,
//    data?: object,
//    createOptions?: Partial<DatabaseCreateOperation<abstract.Document | null>>,
//    options?: {
//      folders?: { id: string; name: string }[]
//      types?: string[]
//      template?: string
...
//  fromDropData<T extends typeof abstract.Document>(
//    this: T,
//    data: object,
//    options?: object,
