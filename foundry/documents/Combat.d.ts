import { DatabaseCreateOperation, DatabaseDeleteOperation, DatabaseUpdateOperation } from "foundry/abstract/_types.js"
...
import { ChatMessageCreateOperation } from "./BaseChatMessage.js"

type BaseCombatStatic = typeof BaseCombat
interface ClientBaseCombatStatic extends BaseCombatStatic, foundry.documents.abstract.ClientDocumentStatic {}

declare const ClientBaseCombat: {
  new (...args: any): BaseCombat & foundry.documents.abstract.ClientDocument<null>
} & ClientBaseCombatStatic

type ClientBaseCombat = InstanceType<typeof ClientBaseCombat>
...
export default class Combat extends ClientBaseCombat {
  ...
  protected override _onCreateDescendantDocuments<TParent extends foundry.abstract.Document>(
    parent: TParent,
    collection: string,
    documents: foundry.documents.abstract.ClientDocument<TParent>,
    data: object[],
  ...
  protected override _onUpdateDescendantDocuments<TParent extends foundry.abstract.Document>(
    parent: TParent,
    collection: string,
    documents: foundry.abstract.Document<TParent>[],
  ...
  protected override _onDeleteDescendantDocuments<TParent extends foundry.abstract.Document>(
    parent: TParent,
    collection: string,
    documents: foundry.abstract.Document<TParent>[],
    ids: string[],
