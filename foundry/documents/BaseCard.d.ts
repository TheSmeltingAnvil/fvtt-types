 ...
 */
export default class BaseCard<TParent extends BaseCards | null> extends foundry.abstract.Document<TParent, CardSchema> {
  /* -------------------------------------------- */
  /*  Model Configuration                         */
  /* -------------------------------------------- */
...
export default interface BaseCard<TParent extends BaseCards | null>
  extends foundry.abstract.Document<TParent, CardSchema>,
