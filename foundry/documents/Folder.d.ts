...
> extends abstract.ClientDocumentMixin(BaseFolder) {
  ...
  get documentCollection(): abstract.WorldCollection<TDocument>
  ...
  static createDialog<TDocument extends foundry.abstract.Document>(
    ...
    } & Partial<foundry.FormApplicationOptions>,
   ...
   */
  exportToCompendium(
    pack: collections.CompendiumCollection<TDocument>,
    { updateByName }?: { updateByName?: boolean },
  ): Promise<collections.CompendiumCollection<TDocument>>
