...
import { BaseRollTable, ChatMessageCreateOperation } from "./_module.js"

type BaseRollTableStatic = typeof BaseRollTable
interface ClientBaseRollTableStatic extends BaseRollTableStatic, abstract.ClientDocumentStatic {}

declare const ClientBaseRollTable: {
  new (...args: any): BaseRollTable & abstract.ClientDocument<null>
} & ClientBaseRollTableStatic

type ClientBaseRollTable = InstanceType<typeof ClientBaseRollTable>
...
export default class RollTable extends ClientBaseRollTable {
  ...
  draw({
    ...
    displayChat?: boolean
    rollMode?: CONST.RollMode | "roll" | null
  ...
  drawMany(
    number: number,
    {
      ...
      displayChat,
      rollMode,
    }?: { roll?: Roll | null; recursive?: boolean; displayChat?: boolean; rollMode?: CONST.RollMode | null },
  ): Promise<RollTableDraw<this>>
  ...
  protected override _onCreateDescendantDocuments<P extends Document>(
    ...
    data: object[],
    options: abstractTypes.DatabaseCreateOperation<P>,
    userId: string,
  ): void
  ...
  protected override _onDeleteDescendantDocuments<P extends Document>(
    ...
    documents: Document<P>[],
    ids: string[],
    options: abstractTypes.DatabaseDeleteOperation<P>,
    userId: string,
  ): void
  ...
  static fromFolder(
    folder: Folder,
    operation?: abstractTypes.DatabaseCreateOperation<null>,
