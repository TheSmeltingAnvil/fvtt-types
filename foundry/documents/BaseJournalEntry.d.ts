...
export default class BaseJournalEntry extends foundry.abstract.Document<null, JournalEntrySchema> {
...
export default interface BaseJournalEntry
  extends foundry.abstract.Document<null, JournalEntrySchema>,
