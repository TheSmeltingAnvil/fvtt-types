...
interface ClientBaseActorStatic extends Omit<typeof documents.BaseActor, "new">, abstract.ClientDocumentStatic {}

declare const ClientBaseActor: {
  new <TParent extends TokenDocument | null>(
    ...args: any
  ): documents.BaseActor<TParent> & abstract.ClientDocument<TParent>
} & ClientBaseActorStatic

type ClientBaseActor<TParent extends TokenDocument | null> = InstanceType<typeof ClientBaseActor<TParent>>
...
declare class Actor<TParent extends TokenDocument | null = TokenDocument | null> extends ClientBaseActor<TParent> {
  ...
  getActiveTokens(linked?: boolean | undefined, document?: false): canvas.placeables.Token<TokenDocument<Scene>>[]
  getActiveTokens(
    linked?: boolean,
    document?: boolean,
  ): TokenDocument<Scene>[] | canvas.placeables.Token<TokenDocument<Scene>>[]
  ...
  getTokenImages(): Promise<(foundry.abstract.ImageFilePath | foundry.abstract.VideoFilePath)[]>
  ...
  protected static _requestTokenImages(
    actorId: string,
    options?: { pack?: string },
  ): Promise<(foundry.abstract.ImageFilePath | foundry.abstract.VideoFilePath)[]>
  ...
  protected override _onDeleteDescendantDocuments<P extends foundry.abstract.Document>(
    parent: P,
    collection: string,
    documents: foundry.abstract.Document<P>[],
    ids: string[],
  ...
  protected _updateDependentTokens(
    ...
    options?: foundry.abstract.types.DatabaseUpdateOperation<TParent>,
  ): void
}
...
declare interface Actor<TParent extends TokenDocument | null = TokenDocument | null> extends ClientBaseActor<TParent> {
  ...
  get sheet(): appv1.sheets.ActorSheet<Actor> | sheets.ActorSheetV2<Actor>

  get uuid(): documents.ActorUUID
}
