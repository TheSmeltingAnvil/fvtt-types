import { ElevatedPoint } from "foundry/_types.js"
...
import TokenConfig from "foundry/applications/sheets/TokenConfig.js"
import Token, { TokenResourceData } from "foundry/canvas/placeables/Token.js"
import { Scene } from "foundry/documents/_module.js"

import * as documents from "./_module.js"
import * as types from "./_types.js"
import * as abstract from "./abstract/_module.js"
import { GridMeasurePathResult } from "foundry/grid/_types.js"
import SchemaField from "foundry/data/fields/SchemaField.js"

interface CanvasBaseTokenStatic extends Omit<typeof documents.BaseToken, "new">, abstract.CanvasDocumentStatic {}

declare const CanvasBaseToken: {
  new <TParent extends Scene | null>(...args: any): documents.BaseToken<TParent> & abstract.CanvasDocument<TParent>
} & CanvasBaseTokenStatic

type CanvasBaseToken<TParent extends Scene | null> = InstanceType<typeof CanvasBaseToken<TParent>>
...
export default class TokenDocument<TParent extends Scene | null = Scene | null> extends CanvasBaseToken<TParent> {
   ...
   */
  get movement(): DeepReadonly<types.TokenMovementData>

  /**
   * The movement continuation state of this Token document.
   * @internal
   */
  _movementContinuation: types.TokenMovementContinuationData
   ...
   */
  get movementHistory(): types.TokenMeasuredMovementWaypoint[]
  ...
  protected override _initializeSource(
    data: object,
    options?: foundry.abstract.types.DataModelConstructionContext<TParent>,
  ): this["_source"]
   ...
   */
  protected _inferRingSubjectTexture(): foundry.abstract.ImageFilePath
   ...
   */
  move(
    waypoints: Partial<types.TokenMovementWaypoint> | Partial<types.TokenMovementWaypoint>[],
    options?: Partial<
      Omit<foundry.abstract.types.DatabaseUpdateOperation<TParent>, "updates"> & {
        method: types.TokenMovementMethod
        autoRotate: boolean
        showRuler: boolean
        constrainOptions: Omit<types.TokenConstrainMovementPathOptions, "preview" | "history">
      }
    >,
  ): Promise<boolean>
   ...
   */
  resize(
    dimensions?: Partial<types.TokenDimensions>,
    options?: Partial<Omit<foundry.abstract.types.DatabaseUpdateOperation<TParent>, "updates">>,
  ): Promise<boolean>
   ...
   * ```
   */
  pauseMovement(): types.TokenResumeMovementCallback | null
  ...
  measureMovementPath(
    ...
    options?: { cost?: types.TokenMovementCostFunction },
  ...
  getCompleteMovementPath(
    waypoints: types.TokenGetCompleteMovementPathWaypoint[],
  ): types.TokenGetCompleteMovementPathWaypoint[]
  ...
  protected _preUpdateMovement(
    movement: DeepReadonly<Omit<types.TokenMovementOperation, "autoRotate" | "showRuler">> &
      Pick<types.TokenMovementOperation, "autoRotate" | "showRuler">,
  ...
  protected _onUpdateMovement(
    movement: DeepReadonly<types.TokenMovementOperation>,
    operation: Partial<DatabaseUpdateOperation<TParent>>,
    user: User,
  ): void
   ...
   * @internal
   */
  static _isMovementUpdate(changes: object, origin: types.TokenPosition): boolean
   ...
   */
  testInsideRegion(region: RegionDocument, data?: Partial<ElevatedPoint & types.TokenDimensions>): boolean
  ...
  segmentizeRegionMovementPath(
    ...
    // @ts-expect-error Should fix.
    waypoints: TokenSegmentizeMovementWaypoint[], // @ts-expect-error Should fix.
   ...
   * @internal
   */
  protected _onUpdateBaseActor(update?: Record<string, unknown>, options?: abstract.DatabaseUpdateCallbackOptions): void
...
export default interface TokenDocument<TParent extends Scene | null = Scene | null> extends CanvasBaseToken<TParent> {
  ...
  get uuid(): documents.TokenDocumentUUID
...
export type TokenUpdateCallbackOptions = Omit<
