import { FromCompendiumOptions, WorldCollection } from "foundry/documents/abstract/_module.js"
 ...
 * ```
 */
export default class Actors<TActor extends Actor<null>> extends WorldCollection<TActor> {
  /**
