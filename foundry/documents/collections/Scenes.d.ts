 ...
 */
export default class Scenes<TDocument extends Scene> extends abstract.WorldCollection<TDocument> {
  /* -------------------------------------------- */
  /*  Properties                                  */
  /* -------------------------------------------- */
  ...
  fromCompendium(
    document: TDocument,
    { clearState, clearSort }?: { clearState?: boolean } & abstract.FromCompendiumOptions,
  ): documents.SceneSource
}
