...
import { DocumentCollection } from "foundry/documents/abstract/_module.js"
...
> extends DocumentCollection<TDocument> {
  ...
  static INDEX_FIELDS: Record<CONST.CompendiumDocumentType, string[]>
  ...
  protected override _onUpdateDocuments(
    documents: TDocument[],
    result: TDocument["_source"][],
    options: foundry.abstract.types.DatabaseUpdateOperation<null>,
    userId: string,
  ): void
  ...
  override _onModifyContents(
    ...
    documents: TDocument[],
    result: unknown[],
    operation: foundry.abstract.types.DatabaseOperation<null>,
    user: User,
  ): void
}
...
export interface CompendiumIndexData {
  ...
  uuid: foundry.documents.CompendiumUUID
