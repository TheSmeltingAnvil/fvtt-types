...
import BaseActorDelta from "./BaseActorDelta.js"
 ...
 */
export default class BaseToken<TParent extends BaseScene | null = BaseScene | null> extends foundry.abstract.Document<
  TParent,
  TokenSchema
> {
...
export default interface BaseToken<TParent extends BaseScene | null = BaseScene | null>
  extends foundry.abstract.Document<TParent, TokenSchema>,
...
type TokenSchema = {
  ...
  displayName: fields.NumberField<CONST.TokenDisplayMode, CONST.TokenDisplayMode, true, false, true>
  ...
  disposition: fields.NumberField<CONST.TokenDisposition, CONST.TokenDisposition, true>
  /** The display mode of Token resource bars, from CONST.TOKEN_DISPLAY_MODES */
  displayBars: fields.NumberField<CONST.TokenDisplayMode, CONST.TokenDisplayMode, true>
