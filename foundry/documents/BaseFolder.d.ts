 ...
 */
export default class BaseFolder extends foundry.abstract.Document<null, FolderSchema> {
...
export default interface BaseFolder
  extends foundry.abstract.Document<null, FolderSchema>,
    fields.ModelPropsFromSchema<FolderSchema> {
...
type FolderSchema = {
  ...
  type: fields.StringField<CONST.FolderDocumentType, CONST.FolderDocumentType, true, false, false>
