 ...
 */
export default class BaseAmbientSound<TParent extends BaseScene | null> extends foundry.abstract.Document<
  TParent,
  AmbientSoundSchema
> {
...
export default interface BaseAmbientSound<TParent extends BaseScene | null>
  extends foundry.abstract.Document<TParent, AmbientSoundSchema>,
