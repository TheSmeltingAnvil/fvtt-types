import { JournalEntryPageSource } from "foundry/documents/BaseJournalEntryPage.js"
import { DocumentSheet } from "../api/_module.js"
import { DocumentRenderOptions } from "foundry/abstract/_types.js"
...
export default class JournalSheet<TJournalEntry extends JournalEntry> extends DocumentSheet<TJournalEntry> {
  //static override get defaultOptions(): foundry.DocumentSheetV1Options
  ...
  static OWNERSHIP_ICONS: Record<CONST.DocumentOwnershipLevel, string | undefined>

  get title(): string

  // @ts-expect-error Should fix.
  protected override _getHeaderButtons(): foundry.ApplicationV1HeaderButton[]

  // @ts-expect-error Should fix.
  override getData(
    options?: Partial<foundry.DocumentSheetV1Options>,
