...
export default class KeyboardManager {
  ...
  ): foundry.types.KeyboardEventContext
   ...
   */
  static getKeyboardEventContext(event: KeyboardEvent, up?: boolean): foundry.types.KeyboardEventContext
   ...
   * @internal
   */
  static _getMatchingActions(context: foundry.types.KeyboardEventContext): foundry.types.KeybindingAction[]
   ...
   * @param options.force Force the event to be handled.
   */
  protected _processKeyboardContext(context: foundry.types.KeyboardEventContext, options?: { force?: boolean }): void
