...
import { ContextMenu, ContextMenuEntry } from "foundry/applications/ux/_module.js"

/** The Application class is responsible for rendering an HTMLElement into the Foundry Virtual Tabletop user interface. */
export default abstract class ApplicationV2<
  TConfig extends types.ApplicationConfiguration = types.ApplicationConfiguration,
  TRenderOptions extends types.ApplicationRenderOptions = types.ApplicationRenderOptions,
  TRenderContext extends types.ApplicationRenderContext = types.ApplicationRenderContext,
> extends foundry.EventEmitter {
   ...
   */
  static DEFAULT_OPTIONS: DeepPartial<types.ApplicationConfiguration>
  ...
  get window(): {
    ...
    pointerStartPosition: types.ApplicationPosition
   ...
   */
  protected _getHeaderControls(): types.ApplicationHeaderControlsEntry[]

  /**
   * Iterate over header control buttons, filtering for controls which are visible for the current client.
   */
  protected _headerControlButtons(): Generator<types.ApplicationHeaderControlsEntry>
   ...
   */
  protected abstract _renderHTML(context: types.ApplicationRenderContext, options: TRenderOptions): Promise<unknown>
  ...
  protected _renderHeaderControl(control: types.ApplicationHeaderControlsEntry): HTMLLIElement
   ...
   */
  close(options?: types.ApplicationClosingOptions): Promise<ApplicationV2>
   ...
   * @param options
   */
  protected _tearDown(options: types.ApplicationClosingOptions): void
   ...
   * @param options Provided render options
   */
  protected _preClose(options: types.ApplicationClosingOptions): Promise<void>
   ...
   * @param options Provided render options
   */
  protected _onClose(options: types.ApplicationClosingOptions): void
   ...
   */
  protected _onSubmitForm(formConfig: types.ApplicationFormConfiguration, event: Event | SubmitEvent): Promise<void>
   ...
   */
  protected _onChangeForm(formConfig: types.ApplicationFormConfiguration, event: Event): void
