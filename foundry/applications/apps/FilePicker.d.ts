...
export interface FilePickerConfiguration extends types.ApplicationConfiguration {
...
interface FilePickerContext extends types.ApplicationRenderContext {
  rootId: string
  bucket?: string | null
  buckets: string[] | null
  canGoBack: boolean
  ...
  user: User
  favorites: Record<string, FavoriteFolder>
  buttons: types.FormFooterButton[]
}
 ...
 */
export default class FilePicker extends api.HandlebarsApplicationMixin(api.ApplicationV2<FilePickerConfiguration>) {
  ...
  static override TABS: Record<string, types.ApplicationTabsConfiguration>
   ...
   */
  constructor(options: types.ApplicationConfiguration & FilePickerConfiguration)
  ...
  override render(options?: Partial<api.HandlebarsRenderOptions>): Promise<this>

  override _prepareContext(options: api.HandlebarsRenderOptions): Promise<FilePickerContext>

  protected override _prepareTabs(group: string): Record<string, types.ApplicationTab>
  ...
  protected override _tearDown(options: types.ApplicationClosingOptions): void

  protected override _onRender(context: FilePickerContext, options: api.HandlebarsRenderOptions): Promise<void>
