import StringTree, { StringTreeEntryFilter, StringTreeNode } from "./StringTree.js"
 ...
 */
export default class WordTree<TEntry extends object = types.WordTreeEntry> extends StringTree<TEntry> {
  /**
