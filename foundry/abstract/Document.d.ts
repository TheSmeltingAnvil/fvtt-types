...
> extends DataModel<TParent, TSchema> {
   ...
   */
  getUserLevel(user: BaseUser): CONST.DocumentOwnershipLevel
   ...
   */
  getUserLevel(user: BaseUser): CONST.DocumentOwnershipLevel | null
...
export type MetadataPermission = CONST.UserRoleName | CONST.UserPermission | ((...args: unknown[]) => boolean)
