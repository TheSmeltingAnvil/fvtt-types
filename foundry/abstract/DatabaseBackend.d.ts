...
export default abstract class DatabaseBackend {
   ...
   */
  get<TDocument extends abstract.Document>(
  ...
  protected _getDocuments<TDocument extends abstract.Document>(
   ...
   */
  delete<TDocument extends abstract.Document>(
    documentClass: ConstructorOf<TDocument>,
   ...
   * @returns An array of deleted Document instances
   */
  protected abstract _deleteDocuments<TDocument extends abstract.Document>(
    documentClass: ConstructorOf<TDocument>,
    operation: DatabaseDeleteOperation<TDocument["parent"]>,
    user: BaseUser,
  ): Promise<TDocument[]>
   ...
   * @internal
   */
  protected _getParent(operation: DatabaseOperation<abstract.Document | null>): Promise<Document | null>
