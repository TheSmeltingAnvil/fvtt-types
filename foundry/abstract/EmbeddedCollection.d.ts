import { CollectionGetOptions } from "foundry/utils/Collection.js"
import { DocumentConstructionContext, DocumentSourceUpdateContext, PreCreate } from "./_types.js"

/** Used for the specific task of containing embedded Document instances within a parent Document. */
export default class EmbeddedCollection<TDocument extends foundry.abstract.Document> extends Collection<
  string,
  TDocument
> {
  constructor(
