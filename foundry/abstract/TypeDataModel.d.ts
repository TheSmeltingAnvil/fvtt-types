...
import * as packages from "../packages/_module.js"
import { DocumentHTMLEmbedConfig } from "config/types.js"
...
export default abstract class TypeDataModel<
  ...
  TSchema extends abstract.types.DataSchema,
> extends abstract.DataModel<TParent, TSchema> {
  ...
  constructor(data?: object, options?: abstract.types.DataModelConstructionContext<abstract.Document | null>)
