import * as containers from "foundry/canvas/containers/_module.js"
import * as interaction from "foundry/canvas/interaction/_module.js"
...
> extends RenderFlagsContainer<TDocument> {
  ...
  controlIcon: containers.ControlIcon | null

  /** A mouse interaction manager instance which handles mouse workflows related to this object. */
  mouseInteractionManager: foundry.helpers.interaction.MouseInteractionManager
  ...
  get layer(): layers.PlaceablesLayer<this>
   ...
   */
  getSnappedPosition(position?: foundry.types.Point): foundry.types.Point
  ...
  protected _onDelete(options: foundry.documents.abstract.DatabaseDeleteCallbackOptions, userId: string): void
  ...
  protected _createInteractionManager(): foundry.helpers.interaction.MouseInteractionManager
   ...
   */
  can(user: User, action: foundry.abstract.types.UserAction): boolean
  ...
  protected _onDragLeftMove(event: layers.PlaceablesLayerPointerEvent<this>): void

  /** Callback actions which occur on a mouse-move operation. */
  protected _onDragLeftDrop(event: layers.PlaceablesLayerPointerEvent<this>): Promise<TDocument[] | void>
  ...
  protected _prepareDragLeftDropUpdates(
    event: layers.PlaceablesLayerPointerEvent<this>,
  ): Record<string, unknown>[] | null

  /** Callback actions which occur on a mouse-move operation. */
  protected _onDragLeftCancel(event: layers.PlaceablesLayerPointerEvent<this>): void

  /** Callback actions which occur on a right mouse-drag operation. */
  protected _onDragRightStart(event: layers.PlaceablesLayerPointerEvent<this>): void

  /** Callback actions which occur on a right mouse-drag operation. */
  protected _onDragRightMove(event: layers.PlaceablesLayerPointerEvent<this>): void

  /** Callback actions which occur on a right mouse-drag operation. */
  protected _onDragRightDrop(event: layers.PlaceablesLayerPointerEvent<this>): Promise<TDocument[] | void>

  /** Callback actions which occur on a right mouse-drag operation. */
  protected _onDragRightCancel(event: layers.PlaceablesLayerPointerEvent<this>): void
...
export class RenderFlagsContainer<TDocument extends CanvasDocument> extends PIXI.Container {
  ...
  static RENDER_FLAGS: Record<string, Partial<interaction.types.RenderFlag>>
   ...
   */
  renderFlags: interaction.RenderFlags
