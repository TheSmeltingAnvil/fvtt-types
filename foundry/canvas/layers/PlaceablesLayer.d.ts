import * as types from "foundry/canvas/layers/_types.js"
...
export default class PlaceablesLayer<
  TObject extends placeables.PlaceableObject = placeables.PlaceableObject,
> extends InteractionLayer {
  /** Sort order for placeables belonging to this layer. */
  static SORT_ORDER: number

  override options: types.PlaceablesLayerOptions
  ...
  clipboard: { objects: placeables.PlaceableObject[]; cut: boolean }
  ...
  get documentCollection(): foundry.documents.abstract.DocumentCollection<TObject["document"]> | null

  /** Obtain a reference to the PlaceableObject class definition which represents the Document type in this layer. */
  static get placeableClass(): AbstractConstructorOf<placeables.PlaceableObject>

  /** If objects on this PlaceablesLayer have a HUD UI, provide a reference to its instance */
  get hud(): foundry.applications.hud.BasePlaceableHUD | null
   ...
   */
  getSnappedPoint(point: foundry.types.Point): foundry.types.Point
